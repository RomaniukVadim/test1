...
$(document).ready(function() {
    ...
    genyx = $.genyxAdmin({
        ...
        navigation: {
            useNavMore: true, //use arrow for hint. true or false
        ...
        setCurrent: {
            absoluteUrl: true, //false, //put true if use absolute path links. example http://www.host.com/dashboard instead of /dashboard
        ...
        rememberExpandedSub: false, //remeber expanded sub menu by user

    ...
    $.fn.genyxAdmin = function(options) { 
       ...
       function setCurrentNav () {
        ...
        function setCurrentClass(mainNavLinkAll, url) {
            ...
            mainNavLinkAll.each(function(index) {
                ...
                if(href === url || url.indexOf(href) > -1) { 
                    ...
                    ulElemList = $(this).parents('ul');
					ulElemList.each(function() {
						ulElem = $(this);
						if(ulElem.hasClass('sub')) {    
							...
							ulElem.show();
							var _this = selElem.parents('li.hasSub').children('a.notExpand');
					...
					if($(this).siblings("ul").hasClass('sub')) {
						if(settings.navigation.useNavMore) {  
							$(this).removeClass("notExpand").addClass("expand");
							$(this).find('span.more').remove();
							$(this).append(navMoreUp);
						}
					}
					if(href === url)
						$(this).attr("href","#");
        ...
        function hoverDropDown(val) {   
            (function(e,t,n){e('<span class="visible-desktop" style="font-size:1px !important" id="vis">.</span>').appendTo("body");
				var r=function(){return e("#vis").is(":visible")},i=e();
				e.fn.dropdownHover=function(n){i=i.add(this.parent());
				return this.each(function(){var s=e(this).parent(),o={delay:500,instantlyCloseOthers:!0},u={delay:e(this).data("delay"),instantlyCloseOthers:e(this).data("close-others")},a=e.extend(!0,{},o,n,u),f;
				s.hover(function(){if(r()){a.instantlyCloseOthers===!0&&i.removeClass("open");
            	t.clearTimeout(f);
				e(this).addClass("open")}},function(){r()&&(f=t.setTimeout(function(){s.removeClass("open")},a.delay))})})};

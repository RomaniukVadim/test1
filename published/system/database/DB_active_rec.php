...
class CI_DB_active_record extends CI_DB_driver {
	...
	*/
	...
	public function on_duplicate($table = '', $set = NULL, $set_update = NULL)
	{
		...
		$sql = $this->_duplicate_insert($this->_protect_identifiers($this->dbprefix.$table), $this->ar_set, $set_update );  
		$this->_reset_write(); 

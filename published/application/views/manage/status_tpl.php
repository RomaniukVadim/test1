				...
				<div class="span12"> 
					...
					<div class="widget"> 
						...
						<div class="widget-content" >  
                            ...
                            <tbody id="StatusList" class="dynamic-list" > 
                            	<tr id="SearchRow"  > 
                                    <td class="center" > 
							...
							<div class="form-actions"> 
                            	...
                            	<a href="#StatusModal" class="btn btn_addcurrency"  data-toggle="modal" target-form="call_result_form" >
	...
	<div class="modal-dialog"  >
	  ...
	  <div class="modal-content"  >
		...
		<div class="modal-header" >
		  ...
		  <h4 class="modal-title"  ><i class="icon20 i-support"></i><span>Manage Status</span></h4>
		</div>
...
function getStatusList(){ 
	...
	$.ajax({ 
		...
		success:function(newdata){   
			...
			searchLoading("hide"); 
			$("#StatusList").find("tr.result_row").remove();
			$("#StatusList").append(newdata.status);
			...
			$('.status_row .edit_status').click(function() {   
				$("html, body").animate({ scrollTop: 0 }, "slow"); 
				var status_id = $(this).attr('status-id');   
				if(status_id)loadAjaxContent("<?=base_url()?>status/popupManageStatus/"+status_id, $("#StatusModal").find(".ajax_content"));  
			});
...
$(function() { 	 
	...
	$('.btn_addcurrency').click(function(e) {  
		$("html, body").animate({ scrollTop: 0 }, "slow");  
		loadAjaxContent("<?=base_url()?>status/popupManageStatus/", $("#StatusModal").find(".ajax_content")); 
	});
	 
   $('#StatusModal').on('hide.bs.modal', function (e) {     
		  $(".select2-drop, .select2-drop-mask").hide();  
		  if(is_change == 1)getStatusList(); 
		  is_change = 0; //global 
	});		 

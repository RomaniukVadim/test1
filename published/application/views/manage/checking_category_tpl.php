        ...
        <div class="crumb">
			<ul class="breadcrumb">
				...
				<li><a href="#">Manange</a><span class="divider">/</span></li>
                  <li class="active">12BET Checking Category</li>
			</ul>  
		</div> 
				...
				<div class="span12"> 
					...
					<div class="widget"> 
						...
						<div class="widget-title">
							<div class="icon">
								<i class="icon20 i-checkmark-circle"></i>
							</div>
						...
						<div class="widget-content" >  
                            ...
                            <tbody id="CategoriesList" class="dynamic-list" > 
                            	<tr id="SearchRow"  > 
                                    ...
                                    <td>
                                       <input class="text_filter" name="s_abbreviation" type="text" rel="1" value="" style="text-align: left; " >
                                    </td> 
							...
							<div class="form-actions"> 
                            	...
                            	<a href="#CheckingCategoryModal" class="btn btn_addcategory"  data-toggle="modal" target-form="checking_category_form" >
...
<div class="modal fade" id="CheckingCategoryModal"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
...
<script> 
function getCheckingCategoriesList(){ 
 	
	$.ajax({ 
		data: $("#search_form").serialize(),
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>checking_category/getCheckingCategoriesList",  
		beforeSend:function(){   
			//show loading 
			searchLoading("show");
		},
		success:function(newdata){   
			...
			$("#CategoriesList").append(newdata.categories);
			...
			$(".pagination_link").click(function(){ 
				...
				getCheckingCategoriesList(); 
			});
			//end pagination 
			
			//edit_method 
			
			$('.category_row .edit_category').click(function() {   
				$("html, body").animate({ scrollTop: 0 }, "slow"); 
				var category_id = $(this).attr('category-id');  
				if(category_id)loadAjaxContent("<?=base_url()?>checking_category/popupManageCheckingCategory/"+category_id, $("#CheckingCategoryModal").find(".ajax_content"));  
			});
...
$(function() { 	 
	...
	$('.btn_addcategory').click(function(e) {  
		$("html, body").animate({ scrollTop: 0 }, "slow");  
		loadAjaxContent("<?=base_url()?>checking_category/popupManageCheckingCategory/", $("#CheckingCategoryModal").find(".ajax_content")); 
	});
	 
   $('#CheckingCategoryModal').on('hide.bs.modal', function (e) {     
		  $(".select2-drop, .select2-drop-mask").hide();  
		  if(is_change == 1)getCheckingCategoriesList();
		  is_change = 0; //global 
	});		 
	
	$('#CheckingCategoryModal').modal({ 
		show: false, 
		keyboard: false
	});	 

				...
				<div class="span12"> 
					...
					<div class="widget"> 
						...
						<div class="widget-content" >  
                            ...
                            <tbody id="UserTypesList" class="dynamic-list" > 
                            	<tr id="SearchRow"  > 
                                    <td class="center" > 
							...
							<div class="form-actions">  
                            	<a href="#UserTypeModal" class="btn btn_addtype"  data-toggle="modal" target-form="call_result_form" >
...
<div class="modal fade" id="UserTypeModal"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
	...
	<div class="modal-dialog"  >
	  ...
	  <div class="modal-content"  >
		...
		<div class="modal-header" >
		  ...
		  <h4 class="modal-title"  ><i class="icon20 i-users-4"></i><span>Manage User Type</span></h4>
		</div>
...
function getUserTypesList(){ 
	$.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>user_types/getUserTypesList",  
		beforeSend:function(){   
			//show loading 
			searchLoading("show");
		},
		success:function(newdata){   
			...
			searchLoading("hide");
			$("#UserTypesList").find("tr.type_row").remove();
			$("#UserTypesList").append(newdata.types);
			...
			$('.type_row .edit_type').click(function() {   
				$("html, body").animate({ scrollTop: 0 }, "slow"); 
				var type_id = $(this).attr('type-id');   
				if(type_id)loadAjaxContent("<?=base_url()?>user_types/popupManageUserType/"+type_id, $("#UserTypeModal").find(".ajax_content"));  
			});
...
$(function() { 	 
	...
	$('.btn_addtype').click(function(e) {  
		$("html, body").animate({ scrollTop: 0 }, "slow");  
		loadAjaxContent("<?=base_url()?>user_types/popupManageUserType/", $("#UserTypeModal").find(".ajax_content")); 
	});
	 
   $('#UserTypeModal').on('hide.bs.modal', function (e) {     
		  $(".select2-drop, .select2-drop-mask").hide();  
		  if(is_change == 1)getUserTypesList(); 
		  is_change = 0; //global 
	});		 

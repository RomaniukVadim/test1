        ...
        <div class="crumb">
			<ul class="breadcrumb">
				...
				<li><a href="#">Manange</a><span class="divider">/</span></li>
                  <li class="active">Result Categories</li>
			</ul>  
		</div> 
				...
				<div class="span12"> 
					...
					<div class="widget"> 
						...
						<div class="widget-content" >  
                            ...
                            <tbody id="ResultList" class="dynamic-list" > 
                            	<tr id="SearchRow"  > 
                                    <td class="center" > 
							...
							<div class="form-actions"> 
                            	...
                            	<a href="#CallResultModal" class="btn btn_addresult"  data-toggle="modal" target-form="call_result_form" >
...
<div class="modal fade" id="CallResultModal"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
	...
	<div class="modal-dialog"  >
	  ...
	  <div class="modal-content"  >
		...
		<div class="modal-header" >
		  ...
		  <h4 class="modal-title"  ><i class="icon20 i-contact-add-2"></i><span>Manage Result Category</span></h4>
		</div>
...
<script> 
function getResultCategoriesList(){ 
 	
	$.ajax({ 
		data: $("#search_form").serialize(),
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>result_categories/getResultCategoriesList",  
		beforeSend:function(){   
			//show loading 
			searchLoading("show");
		},
		success:function(newdata){   
			...
			searchLoading("hide");
			$("#ResultList").find("tr.result_row").remove();
			$("#ResultList").append(newdata.results);
			...
			$('.result_row .edit_result').click(function() {   
				$("html, body").animate({ scrollTop: 0 }, "slow"); 
				var category_id = $(this).attr('category-id');  
				if(category_id)loadAjaxContent("<?=base_url()?>result_categories/popupManageResultCategory/"+category_id, $("#CallResultModal").find(".ajax_content"));  
			});
...
$(function() { 	 
	...
	$('.btn_addresult').click(function(e) {  
		$("html, body").animate({ scrollTop: 0 }, "slow");  
		loadAjaxContent("<?=base_url()?>result_categories/popupManageResultCategory/", $("#CallResultModal").find(".ajax_content")); 
	});
	 
	$('#CallResultModal').on('hide.bs.modal', function (e) {     
   ...
   $('#CallResultModal').on('hide.bs.modal', function (e) {     
		  $(".select2-drop, .select2-drop-mask").hide();  
		  if(is_change == 1)getResultCategoriesList();  
		  is_change = 0; //global 
	});		 
	
	$('#CallResultModal').modal({ 
		show: false, 
		keyboard: false
	});	 

				...
				<div class="span12"> 
					...
					<div class="widget"> 
						...
						<div class="widget-content" >  
                            ...
                            <tbody id="CurrenciesList" class="dynamic-list" > 
                            	<tr id="SearchRow"  > 
                                    <td class="center" > 
                                    ...
                                    <td>
                                       <input class="text_filter" name="s_internal" type="text" rel="1" value="" style="text-align: left; " >
                                    </td>
							...
							<div class="form-actions"> 
                            	...
                            	<a href="#CurrencyModal" class="btn btn_addcurrency"  data-toggle="modal" target-form="call_result_form" >
...
<div class="modal fade" id="CurrencyModal"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
	...
	<div class="modal-dialog"  >
	  ...
	  <div class="modal-content"  >
		...
		<div class="modal-header" >
		  ...
		  <h4 class="modal-title"  ><i class="icon20 i-coin"></i><span>Manage Currency</span></h4>
		</div>
...
function getCurrenciesList(){ 
	...
	$.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>currencies/getCurrenciesList",  
		beforeSend:function(){   
			//show loading 
			searchLoading("show");
		},
		success:function(newdata){   
			...
			searchLoading("hide");
			$("#CurrenciesList").find("tr.result_row").remove();
			$("#CurrenciesList").append(newdata.currencies);
			...
			$('.currency_row .edit_currency').click(function() {   
				$("html, body").animate({ scrollTop: 0 }, "slow"); 
				var currency_id = $(this).attr('currency-id');     
				if(currency_id)loadAjaxContent("<?=base_url()?>currencies/popupManageCurrency/"+currency_id, $("#CurrencyModal").find(".ajax_content"));  
			});
...
$(function() { 	 
	...
	$('.btn_addcurrency').click(function(e) {  
		$("html, body").animate({ scrollTop: 0 }, "slow");  
		loadAjaxContent("<?=base_url()?>currencies/popupManageCurrency/", $("#CurrencyModal").find(".ajax_content")); 
	});
	 
   $('#CurrencyModal').on('hide.bs.modal', function (e) {     
		  $(".select2-drop, .select2-drop-mask").hide();  
		  if(is_change == 1)getCurrenciesList(); 
		  is_change = 0; //global 
	});		 

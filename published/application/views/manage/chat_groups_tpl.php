        ...
        <div class="crumb">
			<ul class="breadcrumb">
				...
				<li><a href="#">Manange</a><span class="divider">/</span></li>
                  <li class="active">Chat Groups</li>
			</ul>  
		</div> 
						...
						<div class="widget-content" >  
                            ...
                            <tbody id="OutcomeList" class="dynamic-list" > 
                            	<tr id="SearchRow"  > 
                                    ...
                                    <td>
                                       <select name="s_usertype" class="select2"  >
                                            <optgroup label="" >    
                                            	<option value="" >- All -</option>
                                            	<?php   
												foreach($user_types as $row=>$user_type) {
												?>
                                                <option value="<?=$user_type->Value?>" ><?=ucwords($user_type->UserTypeName)?></option>
                                                <?php	
												}//end foreach
												?> 
                                            </optgroup>  
							...
							<div class="form-actions"> 
                            	...
                            	<a href="#GroupChatModal" class="btn btn_addgroup"  data-toggle="modal" target-form="call_outcome_form" >
...
<div class="modal fade" id="GroupChatModal"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" tabindex="-1" >
	...
	<div class="modal-dialog"  >
	  ...
	  <div class="modal-content"  >
		...
		<div class="modal-header" >
		  ...
		  <h4 class="modal-title"  ><i class="icon20 i-bubbles-10"></i><span>Manage Chat Group</span></h4>
		</div>
...
<script> 
function getChatGroupsList(){ 
 	
	$.ajax({ 
		data: $("#search_form").serialize(),
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>chat_groups/getChatGroupsList",  
		beforeSend:function(){   
			//show loading 
			searchLoading("show");
		},
		success:function(newdata){   
			...
			$("#OutcomeList").append(newdata.groups);
			...
			$('.group_row .edit_group').click(function() {   
				$("html, body").animate({ scrollTop: 0 }, "slow"); 
				var group_id = $(this).attr('group-id');   
				if(group_id)loadAjaxContent("<?=base_url()?>chat_groups/popupManageChatGroup/"+group_id, $("#GroupChatModal").find(".ajax_content"));  
			});
...
$(function() { 	 
	...
	$('.btn_addgroup').click(function(e) {  
		$("html, body").animate({ scrollTop: 0 }, "slow");  
		loadAjaxContent("<?=base_url()?>chat_groups/popupManageChatGroup/", $("#GroupChatModal").find(".ajax_content")); 
	});
	 
	$('#GroupChatModal').on('hide.bs.modal', function (e) {     
		  $(".select2-drop, .select2-drop-mask").hide();  
		  if(is_change == 1)getChatGroupsList(); 
		  is_change = 0; //global 
	});  
	 
	$('#GroupChatModal').modal({ 
		show: false, 
		keyboard: true
	});	 

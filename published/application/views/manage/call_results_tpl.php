        ...
        <div class="crumb">
			<ul class="breadcrumb">
				...
				<li><a href="#">Manange</a><span class="divider">/</span></li>
                  <li class="active">Call Results</li>
			</ul>  
		</div> 
	...
	<div class="modal-dialog"  >
	  ...
	  <div class="modal-content"  >
		...
		<div class="modal-header" >
		  ...
		  <h4 class="modal-title"  ><i class="icon20 i-phone-4"></i><span>Manage Call Result</span></h4>
		</div>
...
<script> 
function getCallResultsList(){ 
 	
	$.ajax({ 
		data: $("#search_form").serialize(),
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>call_results/getCallResultsList",  
		beforeSend:function(){   
			//show loading 
			//searchLoading("show");
		},
		success:function(newdata){   
			...
			$('.result_row .edit_result').click(function() {   
				...
				if(result_id)loadAjaxContent("<?=base_url()?>call_results/popupManageCallResult/"+result_id, $("#CallResultModal").find(".ajax_content"));  
			});
...
$(function() { 	 
	...
	$('.btn_addresult').click(function(e) {  
		$("html, body").animate({ scrollTop: 0 }, "slow");  
		loadAjaxContent("<?=base_url()?>call_results/popupManageCallResult/", $("#CallResultModal").find(".ajax_content")); 
	});
   ...
   $('#CallResultModal').on('hide.bs.modal', function (e) {     
		  $(".select2-drop, .select2-drop-mask").hide();  
		  if(is_change == 1)getCallResultsList();  
		  is_change = 0; //global 
	});		 

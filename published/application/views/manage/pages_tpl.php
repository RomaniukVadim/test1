				...
				<div class="span12"> 
					...
					<div class="widget"> 
						...
						<div class="widget-content" >  
                            ...
                            <tbody id="PagesList" class="dynamic-list" > 
                            	<tr id="SearchRow"  > 
                                    <td class="center" > 
                                    ...
                                    <td class="center" >
                                       <input class="text_filter" name="s_controller" type="text" rel="1" value="" style="text-align: left; " >
                                    </td> 
							...
							<div class="form-actions"> 
                            	...
                            	<a href="#PageModal" class="btn btn_addpage"  data-toggle="modal" target-form="call_result_form" >
	...
	<div class="modal-dialog"  >
	  ...
	  <div class="modal-content"  >
		...
		<div class="modal-header" >
		  ...
		  <h4 class="modal-title"  ><i class="icon20 i-file-8"></i><span>Manage Page</span></h4>
		</div>
...
function getPagesList(){ 
	...
	$.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>pages/getPagesList",  
		beforeSend:function(){   
			//show loading 
			searchLoading("show");
		},
		success:function(newdata){   
			...
			searchLoading("hide");
			$("#PagesList").find("tr.result_row").remove();
			$("#PagesList").append(newdata.pages);
			...
			//edit page
			$('.page_row .edit_page').click(function() {   
				$("html, body").animate({ scrollTop: 0 }, "slow"); 
				var page_id = $(this).attr('page-id');     
				if(page_id)loadAjaxContent("<?=base_url()?>pages/popupManagePage/"+page_id, $("#PageModal").find(".ajax_content"));  
			});
...
$(function() { 	 
	...
	$('.btn_addpage').click(function(e) {  
		$("html, body").animate({ scrollTop: 0 }, "slow");  
		loadAjaxContent("<?=base_url()?>pages/popupManagePage/", $("#PageModal").find(".ajax_content")); 
	});
	 
   $('#PageModal').on('hide.bs.modal', function (e) {     
		  $(".select2-drop, .select2-drop-mask").hide();  
		  if(is_change == 1)getPagesList();  
		  is_change = 0; //global 
	});		 

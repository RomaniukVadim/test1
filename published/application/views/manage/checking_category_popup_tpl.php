...
<form id="validate_category" name="validate_category" class="form-horizontal"  autocomplete="off" style="margin: 0px; padding: 0px; "  method="post"  onsubmit="return false; " >  
    ...
    <div class="control-group" >   
        ...
        <div class="controls controls-row"  >
            <input type="text" id="category_name" name="category_name" class="tip span12" value="<?=htmlentities(stripslashes($category->CategoryName));?>" maxlength="80" title="Category name" >    
        </div>
    </div>
    <!-- End .control-group -->  
    ...
    <div class="control-group" > 
        ...
        <div class="controls controls-row" >  
            <textarea id="category_desc" name="category_desc" class="span12 tip" rows="4" maxlength="200" title="Category description" ><?=$category->Description?></textarea>
        </div>
    </div>
    <!-- End .control-group --> 
...
<script >
var manageCheckingCategory = function() { 
	 
	$.ajax({ 
		data: $("#validate_category").serialize(), 
		type:"POST",  
		url: "<?=base_url();?>checking_category/manageCheckingCategory", 
		dataType: "JSON",    
		cache: false,
		beforeSend:function(){       

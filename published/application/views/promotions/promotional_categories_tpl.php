				...
				<div class="span12"> 
					...
					<div class="widget"> 
						...
						<div class="widget-title">
							<div class="icon">
								<i class="icon20  i-podium"></i>
							</div>
							<h4>Promotional Categories</h4>
...
<script> 
function getPromotionsCategoriesList(){ 
 	
	$.ajax({ 
		data: $("#search_form").serialize(),
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>promotional_categories/getPromotionsCategoriesList",  
		beforeSend:function(){   
			//show loading 
			searchLoading("show");
		},
		success:function(newdata){   
			...
			$('.activity_row .edit_category').click(function() {   
				...
				if(category_id)loadAjaxContent("<?=base_url()?>promotional_categories/popupManagePromotionCategory/"+category_id, $("#PromotionCategoryModal").find(".ajax_content"));  
			});
...
$(function() { 	 
	...
	$('.btn_addproblem').click(function(e) {  
		$("html, body").animate({ scrollTop: 0 }, "slow");  
		loadAjaxContent("<?=base_url()?>promotional_categories/popupManagePromotionCategory/", $("#PromotionCategoryModal").find(".ajax_content")); 
	});
   ...
   $('#PromotionCategoryModal').on('hide.bs.modal', function (e) {  
		  $(".select2-drop, .select2-drop-mask").hide();  
		  if(is_change == 1)getPromotionsCategoriesList();
		  is_change = 0; //global 
	});			 

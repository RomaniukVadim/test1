					...
					<div class="widget">
						...
						<div class="widget-content" >  
                                ...
                                <div class="span10" > 
                                    ...
                                    <div class="btn-group pull-right call-search margin-right-10" >
                                        ...
                                        <div class="dropdown-menu  opensleft daterangepicker" > 
                                            <!-- advance-search menu--> 
                                            <div class="advance-search" style="min-width: 400px !important;"  >   
                                     ...
                                     <div class="btn-group call-search pull-right margin-right-10">
                                        ...
                                        <div class="dropdown-menu  opensleft daterangepicker" > 
                                            ...
                                            <div class="advance-search"  >   
                                                ...
                                                <div class="control-group"> 
                                                    <label class="radio-inline" >
                                                        Is Uploaded  <input type="checkbox" value="1" name="s_isuploaded" id="s_isuploaded" /> 
                                                    </label>     
							...
							<div class="form-actions"> 
                            	...
                            	<?php /*?><a href="#ActivityModal" class="btn btn_addactivity"  data-toggle="modal" target-form="promotions_form" >
...
function getSearchActivities(){ 
	...
	$.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>search_promotions_activities/getSearchActivities",  
		beforeSend:function(){   
			//show loading 
			searchLoading("show");  
		},
...
function exportSearchActivities(){
	xhr = $.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>search_promotions_activities/exportSearchActivities",
		cache: false,  
		beforeSend:function(){    
			//show loading  
		 	exportLoading("show");  
...
$(function() { 	 
	...
	$("#search_form select[name=s_currency], #search_form select[name=s_product], #search_form select[name=s_categories]").change(function(){   
		...
		changePromotions("<?=base_url()?>promotions/getPromotionsList", product, currency, '', $("select[name=s_promotion]"), '', category);    

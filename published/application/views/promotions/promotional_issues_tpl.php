				...
				<div class="span12"> 
					...
					<div class="widget"> 
						...
						<div class="widget-title">
							<div class="icon">
								<i class="icon20 i-drawer-3"></i>
							</div>
							<h4>Promotional Issues</h4>
						...
						<div class="widget-content" >  
                            ...
                            <input type="hidden" value="<?=$dissue?>" name="s_issue" id="s_issue"  /> 
                            ...
                            <tbody id="CategoryList" class="dynamic-list" > 
                            	<tr id="SearchRow"  > 
                                    <td class="center" > 
							...
							<div class="form-actions"> 
                            	...
                            	<a href="#PromotionCategoryModal" class="btn btn_addproblem"  data-toggle="modal" target-form="access_form" >
...
<div class="modal fade" id="PromotionCategoryModal"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
	...
	<div class="modal-dialog"  >
	  ...
	  <div class="modal-content"  >
		...
		<div class="modal-header" >
		  ...
		  <h4 class="modal-title"  ><i class="icon20 i-podium"></i><span>Manage Promotion Category</span></h4>
		</div>
...
<script> 
function getPromotionsIssuesList(){ 
 	
	$.ajax({ 
		data: $("#search_form").serialize(),
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>promotional_issues/getPromotionsIssuesList",  
		beforeSend:function(){   
			//show loading 
			searchLoading("show");
		},
		success:function(newdata){   
			...
			searchLoading("hide");
			$("#CategoryList").find("tr.activity_row").remove();
			$("#CategoryList").append(newdata.categories);
			...
			$(".pagination_link").click(function(){ 
				...
				getPromotionsIssuesList(); 
			});
			//end pagination 
			
			//edit_method 
			
			$('.activity_row .edit_issue').click(function() {   
				$("html, body").animate({ scrollTop: 0 }, "slow"); 
				var issue_id = $(this).attr('issue-id');    
				if(issue_id)loadAjaxContent("<?=base_url()?>promotional_issues/popupManagePromotionIssue/"+issue_id, $("#PromotionCategoryModal").find(".ajax_content"));  
			});
...
$(function() { 	 
	...
	$('.btn_addproblem').click(function(e) {  
		$("html, body").animate({ scrollTop: 0 }, "slow");  
		loadAjaxContent("<?=base_url()?>promotional_issues/popupManagePromotionIssue/", $("#PromotionCategoryModal").find(".ajax_content")); 
	});
	 
	$('#PromotionCategoryModal').on('hide.bs.modal', function (e) {     
   ...
   $('#PromotionCategoryModal').on('hide.bs.modal', function (e) {     
		  $(".select2-drop, .select2-drop-mask").hide();  
		  if(is_change == 1)getPromotionsIssuesList(); 
		  is_change = 0; //global 
	});			 

						...
						<div class="widget-content panel-body">
							<form id="page_form" class="form-horizontal form-widget-content" role="form" autocomplete="off" onsubmit="return false; ">
								<div class="control-group">
									<div class="span12">
										...
										<div class="controls controls-row">
											<input id="pagename" name="pagename" type="text" class="span8" maxlength="50" />
								...
								<div class="control-group">
									...
									<input type="hidden" name="cmarket[]" value="<?=$market?>"/>
									<div class="span1">
										<?=$market_list[$market]?>
									</div>
								...
								<div class="control-group">
									<div class="span12">
										...
										<div class="controls controls-row">
											Home Page
											<input type="hidden" name="parentmenu" value="0"/>
										</div>
									</div>
								</div>
								<div class="control-group">
								...
								<div class="form-actions">
								  ...
								  <a href="<?=base_url("portal/configure/page/home")?>" class="btn btn-success">Back To List</a>
								</div>
							</form>

	...
	<div class="wrapper" >
        ...
        <div class="crumb">
			<ul class="breadcrumb">
				...
				<li><a href="#">Suggestions/Self Exclusion</a><span class="divider">/</span></li>
				...
				<div class="span12"> 
					...
					<div class="widget"> 
						...
						<div class="widget-content" >  
                            ...
                            <tbody id="TypesList" class="dynamic-list"> 
                            	<tr id="SearchRow"  > 
                                    <td class="center" > 
							...
							<div class="form-actions"> 
                            	...
                            	<a href="#TypeModal" class="btn btn_addtype"  data-toggle="modal" target-form="account_form" >
...
<div class="modal fade" id="TypeModal"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
	...
	<div class="modal-dialog"  >
	  ...
	  <div class="modal-content"  >
		...
		<div class="modal-header" >
		  ...
		  <h4 class="modal-title"  ><i class="icon20 i-bubbles-8"></i><span>Manage Suggestion Types</span></h4>
		</div>
...
function getTypesList(){ 
	...
	$.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>suggestion_types/getTypesList",  
		beforeSend:function(){   
			//show loading 
			searchLoading("show");
		},
		success:function(newdata){    
			...
			$("#TypesList").find("tr.activity_row").remove();
			$("#TypesList").append(newdata.types);
			...
			//edit_method
			$('.activity_row .edit_type').click(function() {   
				$("html, body").animate({ scrollTop: 0 }, "slow"); 
				var type_id = $(this).attr('type-id');    
				if(type_id)loadAjaxContent("<?=base_url()?>suggestion_types/popupManageType/"+type_id, $("#TypeModal").find(".ajax_content"));  
			});
...
$(function() { 	 
	...
	$('.btn_addtype').click(function(e) {  
		$("html, body").animate({ scrollTop: 0 }, "slow");  
		loadAjaxContent("<?=base_url()?>suggestion_types/popupManageType/", $("#TypeModal").find(".ajax_content")); 
	});
	 
	$('#TypeModal').on('hide.bs.modal', function (e) {     
		  $(".select2-drop, .select2-drop-mask").hide();  
		  if(is_change == 1)getTypesList();
		  is_change = 0; //global 
	});  	 

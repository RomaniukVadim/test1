...
function getActivities(){ 
	...
	$.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>suggestions/getActivities",  
		beforeSend:function(){   
			//show loading 
			searchLoading("show");
		},
		success:function(newdata){    
			...
			$('.activity_row .view_activity').click(function() {
				var activity_id = $(this).attr('activity-id');  
				if(activity_id)loadAjaxContent("<?=base_url()?>suggestions/viewActivityDetails/"+activity_id, $("#ActivityDetailsModal").find(".ajax_content"));   
			});
...
function exportActivities(){
	xhr = $.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>suggestions/exportActivities",
		cache: false,  
		beforeSend:function(){    
			//show loading  
		 	exportLoading("show");  

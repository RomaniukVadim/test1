	...
	<div class="wrapper" >
        ...
        <div class="crumb">
			<ul class="breadcrumb">
				...
				<li><a href="#">Suggestions/Self Exclusions</a><span class="divider">/</span></li>
				<li class="active">Search Activities</li>
			</ul>  
		</div> 
		...
		<div class="container-fluid">
			...
			<div id="heading" class="page-header">
				<h1><i class="icon20 i-pencil-5"></i> Suggestions</h1>
			</div> 
						...
						<div class="widget-content" >  
                                ...
                                <div class="span9" > 
                                    ...
                                    <div class="btn-group call-search pull-right margin-right-10">
                                        ...
                                        <div class="dropdown-menu opensleft daterangepicker" >  
                                            ...
                                            <!-- advance-search menu--> 
                                            <div class="advance-search" style="min-width: 380px; " >   
                            ...
                            <tbody id="ActivityList" class="dynamic-list" > 
                            	<tr id="SearchRow"  >  
                                    ...
                                    <td class="center" >
                                    	<select name="s_product" class="select2"  >
                                            <optgroup label="" >    
                                            	<option value="" >- All -</option>
                                            	<?php
												foreach($products as $row=>$product) {
												?>
                                                <option value="<?=$product->ProductID?>" ><?=ucwords($product->Name)?></option>
                                                <?php	
												}//end foreach
												?> 
                                    ...
                                    <td class="center" >
                                    	<select name="s_complainttype" class="select2"  >
                                            <optgroup label="" >    
                                            	<option value="" >- All -</option>
                                            	<?php
												foreach($types as $row=>$type) {
												?>
                                                <option value="<?=$type->ComplaintID?>" ><?=ucwords($type->Name)?></option>
                                                <?php	
												}//end foreach
												?> 
							...
							<div class="form-actions"> 
                            	...
                            	<?php /*?><a href="#ActivityModal" class="btn btn_addactivity"  data-toggle="modal" target-form="suggestions_form" >
	...
	<div class="modal-dialog"  >
	  ...
	  <div class="modal-content"  >
		...
		<div class="modal-header" >
		  ...
		  <h4 class="modal-title"  ><i class="icon20 i-bubble-13"></i>Suggestions/Self Exclusion Update Status</h4>
		</div>
...
<div class="modal fade" id="ActivityDetailsModal"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" tabindex="-1" >
	...
	<div class="modal-dialog"  >
	  ...
	  <div class="modal-content"  >
		...
		<div class="modal-header" >
		  <button type="button" class="close sugbtn" data-dismiss="modal" aria-hidden="true">&times;</button>
		  <h4 class="modal-title"  ><i class="icon20 i-pencil-5"></i>Suggestions/Self Exclusion Details </h4>
		</div>
...
function getSearchActivities(){ 
	...
	$.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>search_suggestions_activities/getSearchActivities",  
		beforeSend:function(){   
			//show loading 
			//searchLoading("show");
		},
		success:function(newdata){    
			...
			$('.activity_row .view_activity').click(function() {
				var activity_id = $(this).attr('activity-id');  
				if(activity_id)loadAjaxContent("<?=base_url()?>suggestions/viewActivityDetails/"+activity_id+"/1", $("#ActivityDetailsModal").find(".ajax_content"));   
			});
...
function exportSearchActivities(){
	xhr = $.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>search_suggestions_activities/exportSearchActivities",
		cache: false,  
		beforeSend:function(){    
			//show loading  
		 	exportLoading("show");  

	...
	<div class="modal-dialog"  >
	  ...
	  <div class="modal-content"  >
		...
		<div class="modal-header" >
		  ...
		  <h4 class="modal-title"  ><i class="icon20 i-user-block"></i><span>Manage Account Related Problem</span></h4>
		</div>
...
function getProblemsList(){ 
	...
	$.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>related_problems/getProblemsList",  
		beforeSend:function(){   
			//show loading 
			searchLoading("show");
		},
		success:function(newdata){ 
			...
			$('.activity_row .edit_problem').click(function() {   
				...
				if(problem_id)loadAjaxContent("<?=base_url()?>related_problems/popupManageProblem/"+problem_id, $("#ProblemModal").find(".ajax_content"));  
			});
...
$(function() { 	 
	...
	$('.btn_addproblem').click(function(e) {  
		$("html, body").animate({ scrollTop: 0 }, "slow");  
		loadAjaxContent("<?=base_url()?>related_problems/popupManageProblem/", $("#ProblemModal").find(".ajax_content")); 
	});

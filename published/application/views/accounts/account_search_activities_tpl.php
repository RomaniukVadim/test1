				...
				<div class="span12"> 
					...
					<div class="widget">
						<div class="widget-title">
							...
							<h4>Search Account Related Issues</h4>
						...
						<div class="widget-content" >  
                                ...
                                <div class="span9" >
                                    ...
                                    <div class="btn-group call-search pull-right margin-right-10">
                                        ...
                                        <div class="dropdown-menu  opensleft daterangepicker" >  
                                            ...
                                            <!-- advance-search menu--> 
                                            <div class="advance-search" style="min-width: 410px; " >   
							...
							<div class="form-actions"> 
                            	...
                            	<?php /*?><a href="#ActivityModal" class="btn btn_addactivity"  data-toggle="modal" target-form="account_form" >
...
function getSearchActivities(){ 
	...
	$.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>search_accounts_issues/getSearchActivities",  
		beforeSend:function(){   
			//show loading 
			searchLoading("show");			 
		},
		success:function(newdata){      		 
			...
			$('.activity_row .view_activity').click(function() {
				var activity_id = $(this).attr('activity-id');  
				if(activity_id)loadAjaxContent("<?=base_url()?>accounts/viewActivityDetails/"+activity_id+"/1", $("#ActivityDetailsModal").find(".ajax_content"));   
			});
...
function exportSearchActivities(){
	xhr = $.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>search_accounts_issues/exportSearchActivities",
		cache: false,  
		beforeSend:function(){    
			//show loading  
		 	exportLoading("show");  

        ...
        <div class="crumb">
			<ul class="breadcrumb">
				...
				<li><a href="#">Banks</a><span class="divider">/</span></li>
                  <li class="active"><?=ucwords($dcategory)?> Categories</li>
			</ul>  
		</div> 
				...
				<div class="span12"> 
					...
					<div class="widget">
						<div class="widget-title">
							...
							<h4><?=ucwords($dcategory)?> Categories</h4>
						...
						<div class="widget-content" >  
							...
							<div class="form-actions"> 
                            	...
                            	<a href="#CategoryModal" class="btn btn_addcategory"  data-toggle="modal" target-form="bank_form" >
	...
	<div class="modal-dialog"  >
	  ...
	  <div class="modal-content"  >
		...
		<div class="modal-header" >
		  ...
		  <h4 class="modal-title"  ><i class="icon20 i-credit"></i><span>Manage <?=ucwords($dcategory)?> Category</span></h4>
		</div>
...
function getDepositMethodsList(){ 
	...
	$.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>deposit_categories/getCategoriesList",  
		beforeSend:function(){   
			//show loading
			searchLoading("show");
		},
		success:function(newdata){    
			...
			$('.activity_row .edit_category').click(function() {   
				...
				if(category_id)loadAjaxContent("<?=base_url()?>deposit_categories/popupManageCategory/"+dcategory+"/"+category_id, $("#CategoryModal").find(".ajax_content"));  
			});
...
$(function() { 	 
	...
	$('.btn_addcategory').click(function(e) {  
		$("html, body").animate({ scrollTop: 0 }, "slow");  
		loadAjaxContent("<?=base_url()?>deposit_categories/popupManageCategory/"+dcategory, $("#CategoryModal").find(".ajax_content")); 
	});

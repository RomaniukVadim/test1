...
<form id="validate_status" name="validate_status" class="form-horizontal"  autocomplete="off" style="margin: 0px; padding: 0px; "  method="post"  onsubmit="return false; " >  
    ...
    <div class="row-fluid" >
        ...
        <div class="span7" >
            ...
            <div class="control-group" >    
                <div class="span6" >
                    <label class="control-label" for="act_problemx">Problem</label> 
                    <div class="controls controls-row"   >
                        <label class="info-label" for="act_problemx" ><?=$activity->ProblemName?></label>
                    </div>
                </div>
            ...
            <div class="control-group" > 
                ...
                <div class="controls controls-row" >  
                    ...
                    <button type="submit" class="btn btn-primary" id="BtnSubmitForm" style="margin-top: 5px; margin-left: 10px; " >Update Status</button>
                </div>
            </div>
            <!-- End .control-group -->  
        ...
        <div class="span5" >
            ...
            <div class="control-group" >  
                <label class="control-label" for="act_ispx">ISP</label> 
                <div class="controls controls-row" >
                    <label class="info-label" for="act_ispx" ><?=($activity->ISP)?$activity->ISP:"_ _ _ _ _ _ _ _ _ _"?></label>
                </div>	 
            </div>
            <!-- End .control-group -->
            
            <div class="control-group" >  
                <label class="control-label" for="act_ipaddressx">IP Address</label> 
                <div class="controls controls-row"   >
                    <label class="info-label" for="act_ipaddressx" ><?=($activity->IPAddress)?$activity->IPAddress:"_ _ _ _ _ _ _ _ _ _"?></label>
                </div>	 
            </div>
            <!-- End .control-group -->
            
            <div class="control-group" >  
                <label class="control-label" for="act_locationx">Location</label> 
                <div class="controls controls-row" >
                    <label class="info-label" for="act_locationx" ><?=($activity->Location)?$activity->Location:"_ _ _ _ _ _ _ _ _ _"?></label>
                </div>	 
            </div>
            <!-- End .control-group -->
             
            <div class="control-group" >  
                <label class="control-label" for="act_urlx">URL Used</label> 
                <div class="controls controls-row" >
                    <label class="info-label" for="act_urlx" ><?=($activity->UsedURL)?$activity->UsedURL:"_ _ _ _ _ _ _ _ _ _"?></label>
                </div>	 
            </div>
            <!-- End .control-group -->
            ...
            <div class="control-group" >  
            	<div class="span6" >
                	<label class="control-label" for="act_browserx">Browser</label> 
                    <div class="controls controls-row" >
                        <label class="info-label" for="act_browserx" ><?=($activity->UsedBrowser)?$activity->UsedBrowser:"_ _ _ _ _ _ _ _ _ _"?></label>
                    </div>
                </div>
                
                <div class="span6" >
                	<label class="control-label" for="act_browserx">Is using Proxy</label> 
                    <div class="controls controls-row" >
                        <label class="info-label" for="act_browserx" ><?=($activity->IsUsingProxy == '1')?"YES":"NO"?></label>
                    </div>
                </div>  
            </div>
            <!-- End .control-group -->
            ...
            <div class="control-group" >  
            	<div class="span6" >
                    ...
                    <div class="controls controls-row" >
                        <label class="info-label" for="act_deviceused" ><?=($activity->DeviceUsed)?$activity->DeviceUsed:"_ _ _ _ _ _ _ _ _ _"?></label>
                    </div>
                </div>
                ...
                <div class="span6" >
                    ...
                    <div class="controls controls-row" >
                        <label class="info-label" for="act_osversion" ><?=($activity->OSVersion)?$activity->OSVersion:"_ _ _ _ _ _ _ _ _ _"?></label>
                    </div>
                </div>  
            </div>
            <!-- End .control-group -->
            ...
            <div class="control-group" >  
                <label class="control-label" for="act_dateaccessedx">Date Accessed</label> 
                <div class="controls controls-row" >
                    <label class="info-label" for="act_dateaccessedx" ><?=($activity->DateAccessed > 0)?date("F d, Y H:i:s", $activity->DateAccessed):"_ _ _ _ _ _ _ _ _ _"?></label>
                </div>	 
            </div>
            <!-- End .control-group -->
            
            <div class="control-group" >  
                <label class="control-label" for="act_ispx">Error Message</label> 
                <div class="controls controls-row" >
                    <label class="info-label" for="act_ispx" ><?=($activity->ErrorMessage)?$activity->ErrorMessage:"_ _ _ _ _ _ _ _ _ _"?></label>
                </div>	 
            </div>
            <!-- End .control-group -->

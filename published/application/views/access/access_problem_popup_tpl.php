...
<form id="validate_category" name="validate_category" class="form-horizontal"  autocomplete="off" style="margin: 0px; padding: 0px; "  method="post"  onsubmit="return false; " >  
    ...
    <div class="control-group" >   
        ...
        <div class="controls controls-row"  >
            <input type="text" id="problem_name" name="problem_name" class="tip span12" value="<?=htmlentities(stripslashes($problem->Name));?>" maxlength="80" title="Problem Name" > 
        </div>
    </div>
    <!-- End .control-group --> 
...
<script >
var manageAccessProblem = function() { 
	 
	$.ajax({ 
		data: $("#validate_category").serialize(), 
		type:"POST",  
		url: "<?=base_url();?>access_problems/manageAccessProblem", 
		dataType: "JSON",    
		cache: false,
		beforeSend:function(){       

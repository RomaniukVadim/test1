	...
	<div class="wrapper" >
        ...
        <div class="crumb">
			<ul class="breadcrumb">
				...
				<li class="active">Website/Mobile Access Issues</li>
			</ul>  
		</div> 
				...
				<div class="span12"> 
					...
					<div class="widget">
						<div class="widget-title">
							...
							<h4>Website/Mobile Access Issues</h4>
						...
						<div class="widget-content" >  
                            ...
                            <div class="row-fluid"> 
                            	...
                            	<div class="span3" >
                                    ...
                                    <a href="#ActivityModal" class="btn btn_addactivity"  data-toggle="modal" target-form="access_form" >
							...
							<div class="form-actions"> 
                                ...
                                <?php if(admin_access() || allow_export_data()){ ?>
                                <!-- export button -->
...
function getActivities(){ 
	...
	$.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>access/getActivities",  
		beforeSend:function(){   
			//show loading 
			searchLoading("show");
		},
		success:function(newdata){    
			...
			$('.activity_row .view_activity').click(function() {
				var activity_id = $(this).attr('activity-id');  
				if(activity_id)loadAjaxContent("<?=base_url()?>access/viewActivityDetails/"+activity_id, $("#ActivityDetailsModal").find(".ajax_content"));   
			});
...
function exportActivities(){
	xhr = $.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>access/exportActivities",
		cache: false,  
		beforeSend:function(){    
			//show loading  
		 	exportLoading("show");  

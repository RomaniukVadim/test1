						...
						<div class="widget-content" >  
                            ...
                            <div class="row-fluid"> 
                                ...
                                <div class="span10" > 
                                    ...
                                    <!-- datepicker -->
                                	<button id="reportrange" class="pull-right btn btn-primary pull-right" > 
                                    ...
                                    <!-- Call Search -->
                                    <?php /*?><div class="btn-group pull-right call-search margin-right-10" >
                                     ...
                                     <div class="btn-group call-search pull-right margin-right-10">
                                        ...
                                        <div class="dropdown-menu opensleft daterangepicker" >  
                                            ...
                                            <!-- advance-search menu--> 
                                            <div class="advance-search" style="min-width: 500px; " >   
...
function getActivities(){ 
	...
	$.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>casino/getActivities",  
		beforeSend:function(){   
			//show loading 
			searchLoading("show");   
		},
		success:function(newdata){   
			...
			$('.activity_row .view_activity').click(function() {
				...
				if(activity_id)loadAjaxContent("<?=base_url()?>casino/viewActivityDetails/"+activity_id, $("#ActivityDetailsModal").find(".ajax_content"), default_tab);
			});
...
function exportActivities(){
	xhr = $.ajax({ 
		...
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>casino/exportActivities",
		cache: false,  
		beforeSend:function(){    
			//show loading  
		 	exportLoading("show");  

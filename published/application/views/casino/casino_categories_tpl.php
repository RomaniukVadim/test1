					...
					<div class="widget"> 
						...
						<div class="widget-content" >  
							...
							<div class="form-actions"> 
                            	...
                            	<a href="#CasinoCategoryModal" class="btn btn_addcategory"  data-toggle="modal" target-form="access_form" >
...
<div class="modal fade" id="CasinoCategoryModal"  role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" >
	...
	<div class="modal-dialog"  >
	  ...
	  <div class="modal-content"  >
		...
		<div class="modal-header" >
		  ...
		  <h4 class="modal-title"  ><i class="icon20 i-podium"></i><span>Manage Casino Category</span></h4>
		</div>
...
<script> 
function getCasinoCategoriesList(){ 
 	
	$.ajax({ 
		data: $("#search_form").serialize(),
		type:"POST",  
		dataType: "JSON",
		url: "<?=base_url();?>casino_categories/getCasinoCategoriesList",  
		beforeSend:function(){   
			//show loading  
			searchLoading("show");
		},
		success:function(newdata){   
			...
			$('.activity_row .edit_category').click(function() {   
				...
				if(category_id)loadAjaxContent("<?=base_url()?>casino_categories/popupManageCasinoCategory/"+category_id, $("#CasinoCategoryModal").find(".ajax_content"));  
			});
...
$(function() { 	 
	...
	$('.btn_addcategory').click(function(e) {  
		$("html, body").animate({ scrollTop: 0 }, "slow");  
		loadAjaxContent("<?=base_url()?>casino_categories/popupManageCasinoCategory/", $("#CasinoCategoryModal").find(".ajax_content")); 
	});
	 
	$('#CasinoCategoryModal').on('hide.bs.modal', function (e) {     
		  $(".select2-drop, .select2-drop-mask").hide();  
		  if(is_change == 1)getCasinoCategoriesList();
		  is_change = 0; //global 
	}); 

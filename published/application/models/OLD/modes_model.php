...
class Modes_Model extends CI_Model {
	...
	public function getModes_()
	{
		...
		while ( $aRow = mysql_fetch_array( $rResult ) )
		{
			...
			{
				$edit_link = (admin_access())?base_url().'manage-modes/'.$aRow[ModeID]:base_url().'view-modes/'.$aRow[ModeID];
				$view_link = base_url().'view-modes/'.$aRow[ModeID];

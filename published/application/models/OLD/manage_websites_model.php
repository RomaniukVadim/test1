<?php
class Manage_Websites_Model extends CI_Model {
	...
	function getWebsiteById_($website_id){  
		$sql = "SELECT WebsiteID, Name, Link, Description, Status
				FROM {$this->table_name}   
				WHERE FIND_IN_SET(WebsiteID, ".$this->db->escape($website_id).")";//
	...
	public function manageWebsites_($table, $datax, $action="add", $index="", $index_value=""){ 
		$test="";
		$data = array(); 
